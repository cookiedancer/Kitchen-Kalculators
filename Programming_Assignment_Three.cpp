...
float exceptionfunc(ifstream& files, string errormessageM, string errormessageP, char marital, int children, 
...
//Got to here before time ran out 6/27/2016
int openfiles(ifstream& files, ofstream& outfile, ofstream& errorfile, string filename);
void closefiles(ifstream& files, ofstream& outfile, ofstream& errorfile);
void readdata(ifstream& files, ofstream& outfile, ofstream& errorfile, string filename, string lastname, char marital,
	int children, float income, float pension);
void outputdata(ifstream& files, ofstream& outfile, ofstream& errorfile, string lastname, char marital, float income,
	float pension, float exemptions, float taxincome, float taxowed);
...
//********************************************************************************************************************
//********************************************************************************************************************
void exemptionfunc(ifstream& files, string errormessageM, string errormessageP, char marital, int children, 
	int errordataM, int errordataP, float pension, float exemptions)
{
	switch (marital)
	{
