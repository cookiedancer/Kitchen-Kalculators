                ...
                if (cin.fail())   //failsafe in case user inputs non-integer value for 'teaspoons'
                    {
                        ...
                        cin >> teaspoons;
                            if (cin.fail())   //failsafe in case user inputs a second non-integer value for 'teaspoons'
                            {
                                cin.clear();
                                cin.ignore(100,'\n');
                                cout << "Okay, now this has just gotten old." << endl;
                                cout << "How many teaspoons are we actually converting today?" << endl;
                                cin >> teaspoons;
                            }
                    }
                ...
                if (cin.fail())   //failsafe in case user inputs non-integer value for 'teaspoons'
                    {
                        ...
                        cin >> teaspoons;
                            if (cin.fail())   //failsafe in case user inputs a second non-integer value for 'teaspoons'
                            {
                                cin.clear();
                                cin.ignore(100,'\n');
                                cout << "You're having fun, aren't you?" << endl;
                                cout << "But seriously, how many teaspoons are we actually converting today?" << endl;
                                cin >> teaspoons;
                            }
                    }
