...
int troll_backup(),
    troll_one(), troll_two(), troll_three(), troll_four(),
    troll_five(), troll_six(), troll_seven(), troll_other();
    //declares functions

int troll_backup() //function called if user inputs invalid data consecutively
    {
        cin.clear();
        cin.ignore(100,'\n');
...
int troll_other() //function called if user inputs invalid data for 'measure'
    {
        cin.clear();
        cin.ignore(100,'\n');
...
int troll_seven() //function called if user inputs 'measure' value larger than 6
    {
        cin.clear();
        cin.ignore(100,'\n');
...
int troll_one() //function called if user inputs invalid 'teaspoon' value
    {
        cin.clear();
        cin.ignore(100,'\n');
        cout << "Thinking outside the box, eh?" << endl;
...
int troll_two() //function called if user inputs invalid 'teaspoon' value
    {
        cin.clear();
        cin.ignore(100,'\n');
...
int main()
{
    ...
    intro.open ("kalculator.intro.txt");
                ...
                if (cin.fail())   //failsafe in case user inputs non-integer value for 'tablespoons'
                    {
                        ...
                        cin >> tablespoons;
                            if (cin.fail())   //failsafe in case user inputs a second non-integer value for 'tablespoons'
                            {
                                cin.clear();
                                cin.ignore(100,'\n');
                                cout << "If I weren't an inanimate machine I'd sigh at you right now." << endl;
                                cout << "How many tablespoons are we actually converting today?" << endl;
                                cin >> tablespoons;
                            }
                    }
                ...
                if (cin.fail())   //failsafe in case user inputs non-integer value for 'tablespoons'
                    {
                        ...
                        cin >> tablespoons;
                            if (cin.fail())   //failsafe in case user inputs a second non-integer value for 'tablespoons'
                            {
                                cin.clear();
                                cin.ignore(100,'\n');
                                cout << "Is it possible that maybe, just maybe, this is getting old?" << endl;
                                cout << "How many tablespoons are we actually converting today?" << endl;
                                cin >> tablespoons;
                            }
                    }
                ...
                if (cin.fail())   //failsafe in case user inputs non-integer value for 'cups'
                    {
                        ...
                        cin >> cups;
                            if (cin.fail())   //failsafe in case user inputs a second non-integer value for 'cups'
                            {
                                cin.clear();
                                cin.ignore(100,'\n');
                                cout << "Okay, that was fun but let's get serious now." << endl;
                                cout << "How many cups are we actually converting today?" << endl;
                                cin >> cups;
                            }
                    }
                ...
                if (cin.fail())   //failsafe in case user inputs non-integer value for 'cups'
                    {
                        ...
                        cin >> cups;
                            if (cin.fail())   //failsafe in case user inputs a second non-integer value for 'cups'
                            {
                                cin.clear();
                                cin.ignore(100,'\n');
                                cout << "Fool me once, shame on me.  Fool me twice..." << endl;
                                cout << "How many cups are we actually converting today?" << endl;
                                cin >> cups;
                            }
                    }
